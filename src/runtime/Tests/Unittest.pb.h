...
@private
  ...
  int32_t packedBool_memorizedSerializedSize;
  PBAppendableArray * packedDoubleArray;
  int32_t packedDouble_memorizedSerializedSize;
  PBAppendableArray * packedFloatArray;
  int32_t packedFloat_memorizedSerializedSize;
  PBAppendableArray * packedInt64Array;
  int32_t packedInt64_memorizedSerializedSize;
  PBAppendableArray * packedUint64Array;
  int32_t packedUint64_memorizedSerializedSize;
  PBAppendableArray * packedInt32Array;
  int32_t packedInt32_memorizedSerializedSize;
  PBAppendableArray * packedFixed64Array;
  int32_t packedFixed64_memorizedSerializedSize;
  PBAppendableArray * packedFixed32Array;
  int32_t packedFixed32_memorizedSerializedSize;
  PBAppendableArray * packedUint32Array;
  int32_t packedUint32_memorizedSerializedSize;
  PBAppendableArray * packedEnumArray;
  int32_t packedEnum_memorizedSerializedSize;
  PBAppendableArray * packedSfixed32Array;
  int32_t packedSfixed32_memorizedSerializedSize;
  PBAppendableArray * packedSfixed64Array;
  int32_t packedSfixed64_memorizedSerializedSize;
  PBAppendableArray * packedSint32Array;
  int32_t packedSint32_memorizedSerializedSize;
  PBAppendableArray * packedSint64Array;
  int32_t packedSint64_memorizedSerializedSize;
}
...
@private
  ...
  int32_t packedExtension_memorizedSerializedSize;
}
